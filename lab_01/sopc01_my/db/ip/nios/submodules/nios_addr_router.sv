...
(
    ...
    localparam PAD2 = log2ceil(32'h8040 - 32'h8020);
    localparam PAD3 = log2ceil(32'h8050 - 32'h8048);
    ...
    // -------------------------------------------------------
    localparam ADDR_RANGE = 32'h8050;
    ...
    always @* begin
        ...
        // ( 0x8020 .. 0x8040 )
        if ( {address[RG:PAD2],{PAD2{1'b0}}} == 'h8020 ) begin
            src_channel = 4'b0100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
        end

        // ( 0x8048 .. 0x8050 )
        if ( {address[RG:PAD3],{PAD3{1'b0}}} == 'h8048 ) begin
            src_channel = 4'b0010;
